...
export const categories = [
  { id: 'living', name: 'Sala', subcategories: ['Sofás', 'Sillones', 'Mesas de Centro', 'Estantes'] },
  { id: 'dining', name: 'Comedor', subcategories: ['Mesas', 'Sillas', 'Aparadores', 'Vitrinas'] },
  { id: 'bedroom', name: 'Dormitorio', subcategories: ['Camas', 'Mesitas de Noche', 'Cómodas', 'Armarios'] },
  { id: 'office', name: 'Oficina', subcategories: ['Escritorios', 'Sillas de Oficina', 'Libreros', 'Archiveros'] },
]
